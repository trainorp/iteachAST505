...
\begin{frame}{Independence}
	\begin{itemize}
		\item \textbf{\emph{Independent events:}} Suppose that the probability of an event, $A$, is the same regardless of whether event $B$ has occured. Then $A$ and $B$ are independent events. \pause
		\item[]
...
Some important terms about diagnostic tests... \pause
	\begin{itemize}
		...
		\begin{itemize}
			...
			\item For test B, the False Positive Rate is: 0.418 \pause
		\end{itemize}
		\item \textbf{\emph{False negative:}} A false positive occurs when a diagnostic test gives a negative reading, but this conclusion is false \pause
		\begin{itemize}
			\item For both test A and B, the False Negative Rate is: 0.025 \pause
		\end{itemize}
...
\begin{frame}{The end of Lecture \#5}
	\begin{center}
		\includegraphics[width=.8 \linewidth]{gambling}
	\end{center}
\end{frame}
